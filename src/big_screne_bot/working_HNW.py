...
# Constants
FILENAME = "HVC_Testing"
TOLERANCE = 0.30
LOG_FILENAME = f'/home/xloop/Downloads/high_value_customer/logs/{FILENAME}.log'
VIDEO_PATH = f'./high_value_customer/video/{FILENAME}.mp4'
OUTPUT_VIDEO = f'./high_value_customer/output/{FILENAME}_tol_{TOLERANCE}.avi'
...
gender_dict = {
    'MALE': ['Mehmaam', 'Faraz', 'Zubair', 'Rehman', 'osama', 'huzaifa'],
